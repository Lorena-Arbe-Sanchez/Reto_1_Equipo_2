...
CREATE DATABASE IF NOT EXISTS `grupo2_2425` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `grupo2_2425`;
...
INSERT INTO `usuarios` (`id`, `administrador`, `dni`, `nombre`, `apellido1`, `apellido2`, `email`, `telefono`, `usuario`, `contrasena`, `imagen`) VALUES
                                                                                                                                                      ...
                                                                                                                                                      (2, 1, '72848585A', 'Aritz', 'Saiz', 'Gonzalez', 'aritz.saiz@aergibide.com', '622003624', 'Aritz', 'Aritz2003', NULL),
...
ALTER TABLE `favoritos`
    ADD PRIMARY KEY (`id`),
  ADD KEY `FAV_ID_USU_FK` (`id_usuario`),
  ADD KEY `FAV_ID_RES_FK` (`id_respuesta`);
