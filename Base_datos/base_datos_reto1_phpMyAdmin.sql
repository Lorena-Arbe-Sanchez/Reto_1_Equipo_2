...
CREATE DATABASE IF NOT EXISTS grupo2_2425;
USE grupo2_2425;
...
-- Volcando datos para la tabla grupo2_2425.usuarios
INSERT INTO usuarios (id, administrador, dni, nombre, apellido1, apellido2, email, telefono, usuario, contrasena, imagen)
VALUES
...
-- Volcando datos para la tabla grupo2_2425.preguntas
INSERT INTO preguntas (id, titulo, descripcion, tema, fecha, id_usuario, archivo, votosLike, votosDislike)
VALUES
...
-- Volcando datos para la tabla grupo2_2425.respuestas
INSERT INTO respuestas (id, solucion, archivo, votosLike, votosDislike, id_pregunta, id_usuario, fecha)
VALUES
