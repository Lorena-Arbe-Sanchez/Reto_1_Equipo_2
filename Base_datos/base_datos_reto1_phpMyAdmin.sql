...
--
-- Servidor: mysql:3306
-- Tiempo de generación: 13-11-2024 a las 09:34:29
...
CREATE TABLE `preguntas` (
                             ...
                             `votosLike` int(11) DEFAULT NULL,
                             `votosDislike` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
...
INSERT INTO `preguntas` (`id`, `titulo`, `descripcion`, `tema`, `fecha`, `id_usuario`, `archivo`, `votosLike`, `votosDislike`) VALUES
...
INSERT INTO `respuestas` (`id`, `solucion`, `archivo`, `votosLike`, `votosDislike`, `id_pregunta`, `id_usuario`, `fecha`) VALUES
...
INSERT INTO `usuarios` (`id`, `administrador`, `dni`, `nombre`, `apellido1`, `apellido2`, `email`, `telefono`, `usuario`, `contrasena`, `imagen`) VALUES
                                                                                                                                                      ...
                                                                                                                                                      (2, 1, '12345679N', 'Carlos', 'Lopez', 'Martínez', 'carlos.lopez@aergibide.com', NULL, 'clopez', 'Admin123', NULL),
                                                                                                                                                      (3, 1, '12345680M', 'Beatriz', 'Ruiz', 'Fernández', 'beatriz.ruiz@aergibide.com', '600345678', 'bruiz', 'Admin123', NULL),
                                                                                                                                                      (4, 1, '12345681L', 'David', 'Sánchez', 'Hernández', 'david.sanchez@aergibide.com', NULL, 'dsanchez', 'Admin123', NULL),
                                                                                                                                                      (5, 1, '12345682K', 'Elena', 'Gómez', 'Jiménez', 'elena.gomez@aergibide.com', '600567890', 'egomez', 'Admin123', NULL),
                                                                                                                                                      (6, 0, '98765432T', 'Juan', 'Alvarez', 'Domínguez', 'juan.alvarez@aergibide.com', '700123456', 'jalvarez', 'User123', NULL),
                                                                                                                                                      (7, 0, '98765433R', 'Lucía', 'Castro', 'Soto', 'lucia.castro@aergibide.com', NULL, 'lcastro', 'User123', NULL),
                                                                                                                                                      (8, 0, '98765434W', 'Mario', 'Hernández', 'Ortiz', 'mario.hernandez@aergibide.com', '700345678', 'mhernandez', 'User123', NULL),
                                                                                                                                                      (9, 0, '98765435A', 'Sara', 'Morales', 'Pérez', 'sara.morales@aergibide.com', NULL, 'smorales', 'User123', NULL),
                                                                                                                                                      (10, 0, '98765436G', 'Pedro', 'Vega', 'Rojas', 'pedro.vega@aergibide.com', '700567890', 'pvega', 'User123', NULL),
                                                                                                                                                      (11, 0, '98765437F', 'Raúl', 'Martínez', 'Cruz', 'raul.martinez@aergibide.com', '701123456', 'rmartinez', 'User123', NULL),
                                                                                                                                                      (12, 0, '98765438D', 'Sonia', 'Ramos', 'López', 'sonia.ramos@aergibide.com', NULL, 'sramos', 'User123', NULL),
                                                                                                                                                      (13, 0, '98765439B', 'Manuel', 'Gutiérrez', 'Pascual', 'manuel.gutierrez@aergibide.com', '701345678', 'mgutierrez', 'User123', NULL),
                                                                                                                                                      (14, 0, '98765440P', 'Isabel', 'Torres', 'Cabrera', 'isabel.torres@aergibide.com', NULL, 'itorres', 'User123', NULL),
                                                                                                                                                      (15, 0, '98765441Q', 'Rafael', 'Flores', 'Ramírez', 'rafael.flores@aergibide.com', '701567890', 'rflores', 'User123', NULL),
                                                                                                                                                      (16, 0, '98765442L', 'Pilar', 'Muñoz', 'Gómez', 'pilar.munoz@aergibide.com', '702123456', 'pmunoz', 'User123', NULL),
                                                                                                                                                      (17, 0, '98765443Z', 'Adrián', 'Cano', 'Ruiz', 'adrian.cano@aergibide.com', '702234567', 'acano', 'User123', NULL),
                                                                                                                                                      (18, 0, '98765444X', 'Marta', 'Serrano', 'Núñez', 'marta.serrano@aergibide.com', NULL, 'mserrano', 'User123', NULL),
                                                                                                                                                      (19, 0, '98765445S', 'Luis', 'Navarro', 'Molina', 'luis.navarro@aergibide.com', '702456789', 'lnavarro', 'User123', NULL),
                                                                                                                                                      (20, 0, '98765446J', 'Teresa', 'Romero', 'Domínguez', 'teresa.romero@aergibide.com', '702567890', 'tromero', 'User123', NULL),
                                                                                                                                                      (21, 0, '98765447H', 'Álvaro', 'Rojas', 'López', 'alvaro.rojas@aergibide.com', NULL, 'arojas', 'User123', NULL),
                                                                                                                                                      (22, 0, '98765448V', 'Carolina', 'Martín', 'Vega', 'carolina.martin@aergibide.com', '703234567', 'cmartin', 'User123', NULL),
                                                                                                                                                      (23, 0, '98765449N', 'Francisco', 'Vázquez', 'Ortega', 'francisco.vazquez@aergibide.com', '703345678', 'fvazquez', 'User123', NULL),
                                                                                                                                                      (24, 0, '98765450T', 'Carmen', 'Benítez', 'Mendoza', 'carmen.benitez@aergibide.com', NULL, 'cbenitez', 'User123', NULL),
                                                                                                                                                      (25, 0, '98765451C', 'Antonio', 'Díaz', 'López', 'antonio.diaz@aergibide.com', '703567890', 'adiaz', 'User123', NULL),
                                                                                                                                                      (26, 0, '98765452M', 'Paula', 'Santos', 'Fernández', 'paula.santos@aergibide.com', '704123456', 'psantos', 'User123', NULL),
                                                                                                                                                      (27, 0, '98765453K', 'Sergio', 'Pérez', 'Muñoz', 'sergio.perez@aergibide.com', NULL, 'sperez', 'User123', NULL),
                                                                                                                                                      (28, 0, '98765454L', 'Lorena', 'Luna', 'Rojas', 'lorena.luna@aergibide.com', '704345678', 'lluna', 'User123', NULL),
                                                                                                                                                      (29, 0, '98765455Y', 'Víctor', 'Méndez', 'Cabrera', 'victor.mendez@aergibide.com', NULL, 'vmendez', 'User123', NULL),
                                                                                                                                                      (30, 0, '98765456R', 'Eva', 'Naranjo', 'García', 'eva.naranjo@aergibide.com', '704567890', 'enaranjo', 'User123', NULL);
...
--
ALTER TABLE `favoritos`
    ADD CONSTRAINT `favoritos_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `favoritos_ibfk_2` FOREIGN KEY (`id_respuesta`) REFERENCES `respuestas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
